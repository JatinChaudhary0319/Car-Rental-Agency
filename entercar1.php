...
if (!empty($_FILES["uploadedimage"]["name"])) {
    ...
    if(move_uploaded_file($temp_name, $target_path)) {
        $query = "INSERT into cars(car_name,car_model,car_nameplate,car_img,price_per_day,seating_capacity, car_availability) VALUES('" . $car_name . "','" . $car_model . "','" . $car_nameplate . "','".$target_path."','" . $price_per_day . "','" . $seating_capacity ."','" . $car_availability ."')";
