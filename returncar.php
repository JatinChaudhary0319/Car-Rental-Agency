...
function dateDiff($start, $end) {
 ...
 $id = $_GET["id"];
 $sql1 = "SELECT c.car_name, c.car_model, c.car_nameplate, rc.rent_start_date, rc.rent_end_date, rc.fare
      ...
      <div class="form-area">
        ...
        <br style="clear: both">
          ...
          <h6 style="margin-bottom: 25px; text-align: center; font-size: 12px;"> Allow your driver to fill the below form </h6>
           ...
           <h5> Car Model:&nbsp;  <?php echo($car_model);?></h5>
           ...
           <h5> Fare:&nbsp;  Rs. <?php echo ($fare . "/day") ;?></h5>

          <div class="form-group">
            <input type="text" class="form-control" id="distance_or_days" name="distance_or_days" placeholder="Enter Number of days" required="" autofocus>
          </div>
