...
<body>
    ...
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        <form role="form" action="updatecar1.php" enctype="multipart/form-data" method="POST">
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> Please Update Your Car Details. </h3>
          ...
          <div class="form-group">
            <input type="text" class="form-control" id="car_nameplate" name="car_nameplate" placeholder="Vehicle Number" required>
          </div>     
          ...
          <div class="form-group">
            <input type="text" class="form-control" id="car_availability" name="car_availability" placeholder="Car Availability" required>
          </div>
          ...
          <div class="form-group">
           ...
           <button type="submit" id="submit" name="submit" class="btn btn-success pull-right"> Submit for Updation</button>    
        </form>
      </div>
    </div>
            ...
            <div style="overflow-x:auto;">
              <table class="table table-striped">
                <thead class="thead-dark">
                  ...
                  <th width="1%"> Seating Capacity </th>
