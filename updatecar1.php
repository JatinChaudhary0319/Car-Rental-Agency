...
$car_availability = $conn->real_escape_string($_POST['car_availability']);
...
$query = "UPDATE cars SET car_name = '$car_name', car_model = '$car_model', car_nameplate = '$car_nameplate', price_per_day = '$price_per_day', seating_capacity = '$seating_capacity', car_availability = '$car_availability' WHERE car_id = $car_id";
$success = $conn->query($query);

header("location: updatecar.php"); //Redirecting 
